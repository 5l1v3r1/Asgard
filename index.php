...
function do_whois($domainname, $server, $port=43)
{
	...
	return $output . "\r\n" . '<hr><p>Simple PHP WHOIS script, copyright (c) <a href="https://lonerangerweb.wordpress.com/">Lone-Ranger</a></p>';
}
...
Note: put "?domain=domain.com" , replace domain.com with you domain.